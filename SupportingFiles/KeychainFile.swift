...
{
    class func UpdateUserProfile(service: String, account:String, data: String)
    {
    ...
    class func RemoveUserProfile(service: String, account:String)
    {
        // Instantiate a new default keychain query
    ...
    class func SaveUserProfile(service: String, account:String, data: String)
    {
    ...
    class func GetUserProfile(service: String, account:String) -> String?
    {
        // Instantiate a new default keychain query
